...
app.get('/home', (req, res) => {
  const data = [
    { id: '45', name: 'komal Gupta', enrollment: 'AJU/220941', course: 'BBA', intermediate: 'Commerce' },
    { id: '46', name: 'Dheeraj Mehta', enrollment: 'AJU/220951', course: 'B.Ed', intermediate: 'ARTs' },
...
app.get('/students', (req, res) =>  {
  const data ={students : [
    { id: '45', name: 'sachin', enrollment: 'AJU/220941', course: 'BBA', intermediate: 'Commerce' },
    { id: '46', name: 'Sonia Mehta', enrollment: 'AJU/220951', course: 'B.Ed', intermediate: 'ARTs' },
    { id: '47', name: 'Karan Risha', enrollment: 'AJU/220961', course: 'B.Tech', intermediate: 'Science' },
    { id: '48', name: 'prity', enrollment: 'AJU/220971', course: 'BCA', intermediate: 'Computer Science' },
    { id: '49', name: 'Kishan  Raj', enrollment: 'AJU/220981', course: 'B.Com', intermediate: 'Commerce' },
    { id: '50', name: 'Pinki Chauhan', enrollment: 'AJU/220991', course: 'BA', intermediate: 'ARTs' },
  ]};
